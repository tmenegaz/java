...
public class Contato implements Comparable<Contato> {
    ...
    public boolean equals(Object o) {
        System.out.printf("equals:%n%s = %s%n", getEmail(), ((Contato) o).getEmail());
    ...
    public int compareTo(Contato contato) {
        System.out.printf("compareTo:%n%s = %s%n", getEmail(), contato.getEmail());
        return getEmail().compareTo(contato.getEmail());
    }
}
